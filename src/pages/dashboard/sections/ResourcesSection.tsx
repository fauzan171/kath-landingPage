      ...
      <div className="bg-white border border-[#0F0F0F]/5 rounded-3xl p-6 lg:p-8 shadow-sm">
        ...
        <div className="space-y-4">
          {guides.map((guide) => (
            <div
              key={guide.id}
              className="p-5 bg-[#F9F8F6] rounded-2xl border border-transparent hover:border-[#0F0F0F]/10 hover:shadow-sm transition-all group"
            >
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white rounded-xl shadow-sm border border-[#0F0F0F]/5 group-hover:border-[#FFB22C]/30 transition-colors">
                  <guide.icon className="w-6 h-6 text-[#FFB22C]" />
                </div>
                <div className="flex-1">
                  <h4 className="font-body font-bold text-[#0F0F0F] group-hover:text-[#FFB22C] transition-colors">
                    {guide.title}
                  </h4>
                  <p className="font-body text-sm text-[#0F0F0F]/60 mt-1">
                    {guide.description}
                  </p>
                  <span className="inline-block mt-2 text-xs font-body font-bold text-[#0F0F0F]/40 uppercase tracking-wider">
                    {guide.type}
                  </span>
                </div>
                <button className="flex items-center gap-2 px-4 py-2 bg-white rounded-xl text-sm font-body font-bold text-[#0F0F0F]/70 hover:bg-[#FFB22C] hover:text-white border border-[#0F0F0F]/10 hover:border-[#FFB22C] transition-all opacity-0 group-hover:opacity-100">
