import { FileText, AlertCircle, Download, Star, Clock, CheckCircle2, XCircle, Upload } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="font-body text-sm text-[#0F0F0F]/60 mt-1">
              {language === 'id'
                ? 'Lihat status dan hasil penilaian submission Anda'
                : 'View your submission status and grading results'}
            </p>
          </div>
      ...
      {!hasSubmissions && (
        <div className="bg-white border border-[#0F0F0F]/5 rounded-3xl p-8 shadow-sm">
          <div className="text-center py-8">
            ...
            <p className="font-body text-[#0F0F0F]/60 max-w-md mx-auto">
              {language === 'id'
                ? 'Submission Anda akan muncul di sini setelah dinilai oleh juri. Silakan tunggu hasil penilaian dari admin.'
                : 'Your submissions will appear here after being graded by judges. Please wait for the grading results from admin.'}
            </p>
          </div>
        </div>
      )}
