  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          <StarIcon className="w-6 h-6 md:w-8 md:h-8 text-kath-gold spin-slow" />
        </div>
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 pt-16 border-t border-kath-charcoal/50"
        >
        ...
        <div className="flex justify-center mt-12">
          <StarIcon className="w-4 h-4 text-kath-gold/50" />
        </div>
      </div>
    </section>
  );
