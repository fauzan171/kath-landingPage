  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          <StarIcon className="w-8 h-8 md:w-8 md:h-8 text-[#FFB22C] spin-slow" />
        </div>

        {/* Narrative Text */}
        <div className="space-y-4 md:space-y-6 lg:space-y-8">
          <p ref={line1Ref} className="font-display text-3xl md:text-3xl lg:text-headline text-[#0F0F0F]">
            {narrativeTextConfig.line1[language]}
          </p>

          <p ref={line2Ref} className="font-display text-xl md:text-xl lg:text-subheadline text-[#FFB22C] italic max-w-xl md:max-w-2xl mx-auto">
            {narrativeTextConfig.line2[language]}
          </p>

          {/* Diubah dari text-gray-600 menjadi text-[#0F0F0F]/70 */}
          <p ref={line3Ref} className="font-body text-sm md:text-sm lg:text-base text-[#0F0F0F]/70 max-w-md md:max-w-2xl mx-auto leading-relaxed">
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-4 gap-4 md:gap-6 mt-10 md:mt-16 pt-10 md:pt-16 border-t border-[#FFB22C]/20"
        >
          {/* Diubah teks label dari text-gray-500 menjadi text-[#0F0F0F]/60 */}
          <div className="text-center">
            <span className="font-display text-3xl md:text-3xl lg:text-4xl text-[#FFB22C]">
